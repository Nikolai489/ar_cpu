...
void Vcve2_alu___024root___eval_triggers__ico(Vcve2_alu___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcve2_alu___024root___eval_triggers__ico\n"); );
    // Body
...
VL_INLINE_OPT void Vcve2_alu___024root___ico_sequent__TOP__0(Vcve2_alu___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcve2_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcve2_alu___024root___ico_sequent__TOP__0\n"); );
    // Body
    ...
    if ((1U & (~ VL_ONEHOT0_I((IData)(vlSelf->multdiv_sel_i))))) {
        if (VL_UNLIKELY(vlSymsp->_vm_contextp__->assertOn())) {
            VL_WRITEF("[%0t] %%Error: cve2_alu.sv:96: Assertion failed in %Ncve2_alu: synthesis parallel_case, but multiple matches found\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("dut_verilog/cve2_alu.sv", 96, "");
        }
    }
    ...
    if ((1U & (~ VL_ONEHOT0_I((((IData)(vlSelf->cve2_alu__DOT__bwlogic_and) 
        ...
        if (VL_UNLIKELY(vlSymsp->_vm_contextp__->assertOn())) {
            VL_WRITEF("[%0t] %%Error: cve2_alu.sv:403: Assertion failed in %Ncve2_alu: synthesis parallel_case, but multiple matches found\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("dut_verilog/cve2_alu.sv", 403, "");
        }
    }
    if ((1U & (~ (IData)(vlSelf->multdiv_sel_i)))) {
    ...
    if ((1U & (~ VL_ONEHOT0_I((((IData)(vlSelf->cve2_alu__DOT__adder_op_b_negate) 
        ...
        if (VL_UNLIKELY(vlSymsp->_vm_contextp__->assertOn())) {
            VL_WRITEF("[%0t] %%Error: cve2_alu.sv:108: Assertion failed in %Ncve2_alu: synthesis parallel_case, but multiple matches found\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("dut_verilog/cve2_alu.sv", 108, "");
        }
    }
...
void Vcve2_alu___024root___eval_triggers__act(Vcve2_alu___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcve2_alu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcve2_alu___024root___eval_triggers__act\n"); );
    // Body
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
