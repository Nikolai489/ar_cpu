...
#endif
                VL_FATAL_MT("dut_verilog/cve2_alu.sv", 15, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("dut_verilog/cve2_alu.sv", 15, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("dut_verilog/cve2_alu.sv", 15, "", "NBA region did not converge.");
            }
