...
void Vibex_compressed_decoder___024root___eval_ico(Vibex_compressed_decoder___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vibex_compressed_decoder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_compressed_decoder___024root___eval_ico\n"); );
    // Body
...
void Vibex_compressed_decoder___024root___eval_act(Vibex_compressed_decoder___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vibex_compressed_decoder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_compressed_decoder___024root___eval_act\n"); );
}

void Vibex_compressed_decoder___024root___eval_nba(Vibex_compressed_decoder___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vibex_compressed_decoder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_compressed_decoder___024root___eval_nba\n"); );
}
...
void Vibex_compressed_decoder___024root___eval(Vibex_compressed_decoder___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vibex_compressed_decoder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_compressed_decoder___024root___eval\n"); );
    // Init
    ...
    while (__VicoContinue) {
        __VicoContinue = 0U;
        Vibex_compressed_decoder___024root___eval_triggers__ico(vlSelf);
...
#endif
                VL_FATAL_MT("verilog/ibex_compressed_decoder.v", 17, "", "Input combinational region did not converge.");
            }
            vlSelf->__VicoIterCount = ((IData)(1U) 
                                       + vlSelf->__VicoIterCount);
            Vibex_compressed_decoder___024root___eval_ico(vlSelf);
        }
    }
    __VnbaIterCount = 0U;
    __VnbaContinue = 1U;
    while (__VnbaContinue) {
        ...
        while (vlSelf->__VactContinue) {
            ...
            Vibex_compressed_decoder___024root___eval_triggers__act(vlSelf);
...
#endif
                    VL_FATAL_MT("verilog/ibex_compressed_decoder.v", 17, "", "Active region did not converge.");
                }
                vlSelf->__VactIterCount = ((IData)(1U) 
                                           + vlSelf->__VactIterCount);
                __VpreTriggered.andNot(vlSelf->__VactTriggered, vlSelf->__VnbaTriggered);
                vlSelf->__VnbaTriggered.thisOr(vlSelf->__VactTriggered);
                Vibex_compressed_decoder___024root___eval_act(vlSelf);
            }
        }
...
#ifdef VL_DEBUG
                Vibex_compressed_decoder___024root___dump_triggers__nba(vlSelf);
#endif
                VL_FATAL_MT("verilog/ibex_compressed_decoder.v", 17, "", "NBA region did not converge.");
            }
            __VnbaIterCount = ((IData)(1U) + __VnbaIterCount);
            Vibex_compressed_decoder___024root___eval_nba(vlSelf);
        }
    }
}
...
void Vibex_compressed_decoder___024root___eval_debug_assertions(Vibex_compressed_decoder___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vibex_compressed_decoder__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vibex_compressed_decoder___024root___eval_debug_assertions\n"); );
    // Body
